...
public class ItemPickerDialogFragment extends DialogFragment {
    ...
    public static final String LOGTAG = "ItemPickerDialogFrag";
    ...
    public interface OnItemSelectedListener {
        ...
        void onItemSelected(ItemPickerDialogFragment fragment, ArrayList<Item> Items);
    }
    ...
    private ArrayList<String> selectedItemsTitles = new ArrayList<>();

    public ArrayList<Integer> SelectedItemsIndices(){
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(getActivity().getApplication().getApplicationContext());
...
//                        Toast.makeText(getActivity().getApplication().getApplicationContext(), "Selected index: " + selectedIndex, Toast.LENGTH_LONG).show();

                        //
//                        for (Integer i : selectedItems){
//                            selectedItemsTitles.set(i, itemTitles[i]);
//                        }
...
////                                listener.onItemSelected(ItemPickerDialogFragment.this, selectedItems);
//                            }
//                        }
                    }
                })
...
//                })
                ...
                .setMultiChoiceItems(itemTitles, null, new DialogInterface.OnMultiChoiceClickListener() {
                    @Override
